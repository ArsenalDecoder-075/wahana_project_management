...
<div class="container-fluid">
    ...
    <div class="row mb-4" style="display: flex; flex-wrap: wrap;">
        ...
        <div class="col-lg-8" style="display: flex;">
            <div class="card-style mb-30"  style="flex: 1;">
                ...
                <form action="{{ route('manager.tasks.store') }}" method="POST" id="addTaskForm">
                    @csrf
    ...
    <div class="card-style">
        <div class="title mb-20">
            <h5><i class="fa-solid fa-list-ol"></i> Daftar Tugas</h5>
            <p class="text-muted">Katalog tugas, di urutkan berdasarkan tugas yang paling tinggi di prioritaskan.</p>
        </div>
