                ...
                <div class="card-style mb-30">
                    <div class="card-body">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-12">
                                    <div class="info-item p-3 bg-light rounded">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <span class="fw-semibold text-dark">Cabang</span>
                                            </div>
                                            <div class="col-sm-8">
                                                <span class="text-muted">
                                                    ...
                                                    @if ($user->branch)
                                                        <span
                                                            class="badge bg-secondary ms-1">{{ $user->branch->initials }}</span>
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="text-center pt-3 border-top">
                            <a href="{{ route('user.changePassword') }}" class="btn btn-success px-4">
