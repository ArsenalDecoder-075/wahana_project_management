...
<head>
    ...
    <link rel="preload" href="{{ asset('fonts/LineIcons.woff2') }}" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="{{ asset('css/lineicons.css') }}" as="style">
                        ...
                        <div class="header-right">
                            ...
                            <div class="profile-box ml-15">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                                    <li>
                                        <a href="{{ route('user.profile') }}"> <i class="lni lni-user"></i>
                                            {{ __('Profile Saya') }}</a>
                                    </li>
                                    <li>
